    ...
    services.slurm = {
      ...
      rest = {
        ...
        extraEnv = lib.mkOption {
          ...
          default = { };
          description = "Extra environment variables to set for slurmrestd, see slurmrestd(8).";
        };
      };
    ...
    lib.mkIf
      ...
      )
      {
        ...
        users.users.slurmrestd = lib.mkIf (cfg.rest.enable) {
          name = "slurmrestd";
          group = "slurmrestd";
          uid = config.ids.uids.slurmrestd;
        };

        users.groups.slurmrestd.gid = config.ids.uids.slurmrestd;
        ...
        systemd.services.slurmrestd = lib.mkIf (cfg.rest.enable) {
          ...
          serviceConfig = {
            Type = "simple";
            ExecStart = "${wrappedSlurm}/bin/slurmrestd $SLURMRESTD_OPTIONS";
          ...
          environment = {
            SLURM_JWT = "daemon";
            SLURMRESTD_LISTEN = cfg.rest.listen;
            SLURMRESTD_DEBUG = cfg.rest.debug;
          }
          // cfg.rest.extraEnv;
        };
      };
